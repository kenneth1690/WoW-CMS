...
<div class="content-wrapper">
			...
			$checkreaded = mysqli_query($conn, "SELECT * FROM tickets WHERE id=$ticid AND readed='0'");
			if(mysqli_num_rows($checkreaded) != 0){
				$setreaded = mysqli_query($conn, "UPDATE tickets SET readed='1' WHERE id=$ticid");
			}
            ...
            if(isset($ticid)){
                ...
                if(mysqli_num_rows($checktic)>0){
                    ...
                    if($idcheck==$rowtic['author_id']){
						...
						<center>
							<p>
								<font size="6">Ticket view failed</font>
							</p>
							<p>
