		...
		<div id="wm-error-page">
			<?php 
				session_start();
					...
					if($rowscms['id']==$chgsidcheck){
						if(empty($editchgcontentcheck)){
							header("refresh:5;url=index.php");
							?>
							<center>
							<p><font size="6">Error when editing</font></p>
							<p>
								<font size="5">You must edit 'content' field.</font>
							</p> 
							</center>
							<?php
						}else{
							...
							$insertlog = mysqli_query($cmsconn, "INSERT INTO logs_gm (`logger`, `logger_id`, `logger_gmlevel`, `logdetails`, `logdate`) 
									  VALUES ('".$_SESSION['loggedin']."', '".$rows['id']."', '".$rowsgm['gmlevel']."', 'CHANGELOGS: User `".$nick."` edited changelogs (CHID: ".$_GET['chgsid'].")', NOW());");
							header("refresh:5;url=index.php");
							?>
							<center>
							<p><font size="6">Changelog edited</font></p>
							<p>
								<font size="5">Your changelog has been edited in the database.</font>
							</p> 
							</center>
							<?php
						}
						...
						<p>
							<font size="5">You tried to edit changelogs that not exists.</font>
						</p> 
						</center>
						<?php
					}
