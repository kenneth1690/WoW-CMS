...
<?php 
				session_start();
					...
					$resultnewscreator = mysqli_query($checkacp, "SELECT * FROM account WHERE username = '" . $rowscms['author'] . "'");
					$rowscreator = mysqli_fetch_array($resultnewscreator);
					
					$resultnewseditor = mysqli_query($checkacp, "SELECT * FROM account WHERE username = '" . $rowscms['edited_by'] . "'");
					$rowseditor = mysqli_fetch_array($resultnewseditor);
							...
							<div id="content-wrapper">
								<div id="content-inner" class="wm-ui-generic-frame wm-ui-genericform wm-ui-two-side-page-left wm-ui-content-fontstyle wm-ui-right-border wm-ui-top-border" style="height: auto;">
									...
									<table>
										...
										<tr>
											<td>Title:<br><font color="white"><?php echo $rowscms['title']; ?></font></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
										</tr>
						...
						<div class="content-wrapper">
							<div id="content-inner" class="wm-ui-content-fontstyle wm-ui-generic-frame">
								<div id="wm-error-page">
									...
									<p>
										<font size="5">You tried to show details of news that not exists.</font>
									</p> 
									</center>
								</div>
							</div>
