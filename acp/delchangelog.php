			...
			<?php 
				session_start();
					...
					if($rowscms['id']==$chgsid){
						?>
							<form action='delchangelogconf.php' 'method='POST'>
								<input type="hidden" name="chgsid" id="chgsid" value="<?php echo $chgsid;?>" />
								<p>Are you sure you want to delete #<?php echo $chgsid; ?> Changelogs?</p>
